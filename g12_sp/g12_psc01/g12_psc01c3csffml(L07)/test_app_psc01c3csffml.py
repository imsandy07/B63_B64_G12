...
# - Launch a terminal (command prompt) in IDE and activate the project's virtual environment
# - Got to the directory where the test_app.py file is located.
# - use command python test_app.py --## to run the test (replace ## with your group number)
